package lista.pkginterface;

import javax.swing.JOptionPane;

public class jfDolarReal extends javax.swing.JFrame 
{
    public jfDolarReal() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONVERTER DÓLAR PARA REAL");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtCotacao, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnConverterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConverterActionPerformed
        dblCotacao = Double.parseDouble(txtCotacao.getText());
        dblValor = Double.parseDouble(txtValor.getText());
        
        JOptionPane.showMessageDialog(rootPane, dblValor + "dólares é igual a " + dblCotacao * dblValor + " reais");
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                new jfDolarReal().setVisible(true);
            }
        });
    }
